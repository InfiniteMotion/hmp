...
import com.hmp.domain.agent.runtime.GlobalAgentConfig
...
class MinimalSettingsRepository : SettingsRepository {
    ...
    override suspend fun getAgentEndpointConfig(agentRole: String): AiEndpointConfig? = unused()
    override suspend fun saveAgentEndpointConfig(agentRole: String, config: AiEndpointConfig?) = unused()
    override suspend fun getGlobalAgentConfig(): GlobalAgentConfig = GlobalAgentConfig()
    override suspend fun saveGlobalAgentConfig(config: GlobalAgentConfig) = unused()
