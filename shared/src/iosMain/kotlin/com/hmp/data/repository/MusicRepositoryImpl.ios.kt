...
/**
 * iOS 播放器仓库实现（B0 去重后仅保留平台分叉）：NSFileManager 目录扫描（DeviceMusicScanner）/
 * 排序语义差异方法。其余 DAO/AI/统计/备份逻辑在 [MusicRepositoryBase]。
 */
class MusicRepositoryImpl(
    ...
    // region Query（本端排序语义与 Android/Desktop 刻意不同，留在平台层）
