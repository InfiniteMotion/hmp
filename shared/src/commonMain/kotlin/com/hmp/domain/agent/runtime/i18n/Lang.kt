 ...
 *
 * 本包（`runtime/i18n`）承载**语言与文案资源**：本枚举 + [L10N_PROMPTS] 出厂默认词表
 * + [resolvePrompt] 解析函数。它与引擎机制（ReActLoop / AgentScheduler 等）无关，
 * 故单独成包，不混在 `runtime/` 平铺目录里。
 */
 ...
 */
internal val L10N_PROMPTS: Map<String, Map<Lang, String>> = mapOf(
    // ────────────────────────
