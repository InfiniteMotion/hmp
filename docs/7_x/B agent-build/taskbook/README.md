...
**进行中**：F9-T0 用户认识模块（契约 **v3** 定稿：`../design/agent-profile.md`，代码未动；已拆 T0a 地基+MVP / T0b 后置）
...
| [F9](f9-报告与语音.md) | 报告与语音 | **T0 用户认识**（T0a / T0b） → T1/T2 → T3/T4 | 主轴 | 🟠 T0 契约 v3 定稿 | — | — |
